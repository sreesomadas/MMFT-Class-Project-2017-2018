...
def importLoopSites():
    ...
    cur.execute(sql)
    con.commit()    
    fn_sites = "/headless/MMft_Class_Project-1718/LoopDetectorDataLess/LoopDetectorLess.csv"
...
def importDetections():
    ...
    cur.execute(sql)    
    dir_detections = "/headless/MMft_Class_Project-1718/LoopDetectorDataLess/LoopData/"
